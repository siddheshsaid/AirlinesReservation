 ...
 <!-- LINK TAG FOR SLIDER -->
    ...
    <div id="mySidebar" class="sidebar">
        <div class="sidebar-content">
              ...
              <ol>
              <li><a href="<c:url value='searchCities'/> "><b>Calculate Cost</b></a></li>
              <li><a href="<c:url value='searchFlightStatus'/> "><b>Check Flight Status</b></a></li>
              </ol>
                         ...
                         <div class="main">
                             <!-- <div class="main-card"> -->
                                 <div class="card-4">
                                     ...
                                     <div class="content-4">
                                     <p class="paragraph-4">
                                     baggage rules,weight limits<br> and charges <br>Stay informed for a seamless journey
                                     with <br>all the essential details you need to know
                                     </p>
                                 ...
                                 <div class="card-3">
                                     ...
                                     <div class="content-3">
                                    <p>All airports information is available here
                                    <br> click here for more details</p>
                                     <button class="learn-more">Learn More</button>
                                 </div>
                                 </div>
                             </div>
